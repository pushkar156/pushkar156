...
| | |
|---|---|
| **Year 1 🌱** | Got introduced to C and C++. Fell in love with problem-solving and algorithms. Built my first web pages with HTML & CSS. |
| **Year 2 (Now) 🔥** | Diving into full-stack web dev with React, Node.js & Django. Exploring AI/ML with hands-on projects like the ASL CNN. Building FinBot and leveling up in backend systems. |
| **Next 🚀** | Cloud & DevOps, deeper AI/ML, open source contributions, and shipping more production-ready projects. |
